...
export const VerifyRSVP = () => {
	...
	useEffect(() => {
		if (currentUser?.rsvpVerified) navigate("/");
						...
						<div className="text-center space-y-4 max-w-2xl mx-auto">
							...
							{inWaitlist && (
								<>
									...
									<p>
										Once you receive your email, you&apos;ll have{" "}
										<span className="font-bold">24 hours to RSVP</span> before
										we move on to the next person in line. Keep checking this
										page for your live spot on the waitlist to ensure you
										don&apos;t miss it -{" "}
							...
							<p className="text-gray-700">
								If you have any questions or concerns, please reach out to us in
								our tech support channel on Discord.
							</p>
							{/* {!inWaitlist && ( */}
							{/*     <Button */}
							{/*         onClick={join} */}
									...
									<div className="flex flex-col items-start max-w-3xl">
										<div>
											<label className="inline-flex items-center gap-3 mt-3">
												...
												<span className="ml-2 text-gray-700 cursor-pointer">
													I have read the content below and agree to participate
													in the event using my free will and good judgment.
												</span>
											</label>
										...
										<label className="inline-flex items-center gap-3 mt-3">
											...
											<span className="ml-2 text-gray-700">
												...
												from May 17th to May 19th. I will try to be on the
												premises for the vast majority for the duration of the
												event.
											</span>
										</label>
									</div>
