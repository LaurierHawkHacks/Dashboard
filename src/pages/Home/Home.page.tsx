		...
		<PageWrapper title="Home" subTitle="Welcome to the home page">
					...
					>
						<div className="flex gap-2">
							<p className="text-[#333] text-sm lg:max-w-[37.5rem]">
								...
								any help or support, and please be sure to join the HawkHacks
								Discord community!
							</p>
							<img className="hidden sm:block" src={IpadKidHawks} alt="" />
						</div>

						<SocialIcons className="mt-8" />
					</Card>

					<Card title="Our Sponsors" className="grid sponsors xl:col-span-7">
						<div className="text-[#333] text-sm">
							<p>
								Thank you to all our sponsors! Without them, HawkHacks could not
								have happened!
								<br />
								<br />
			...
			>
				<div className="flex gap-4 justify-center">
					...
					<Button onClick={() => withdraw()} disabled={disableAllActions}>
						Withdraw
					</Button>
				</div>
			</Modal>
